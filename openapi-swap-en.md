...
* [coinbene-swap-rest Quotes and trading interface](#coinbene-swap-rest Quotes and trading interface)
  * [Basic Information](#Basic Information)
  * [Access Restrictions] (#Access Restrictions)
  * [interface type] (#interface type)
  * [Signature Method] (#Signature Method)
  * [interface specification] (#interface specification)
  * [Common Interface - Get Depth] (#Common Interface - Get Depth)
  * [public interface - get all ticker information] (# public interface - get all ticker information)
  * [Common interface - Get K line data] (#Common interface - Get k line data)
...
  * [Private Interface - Contract Position Information] (#Private Interface - Contract Position Information)
  * [Private Interface - Order] (#Private Interface - Order)
  * [Private Interface - Specify Withdrawal] (#Private Interface - Specify Withdrawal)
  * [Private Interface - Query all current order list] (#Private Interface - Query all current order list)
 * [Private Interface - Get Specified Order Information] (#Private Interface - Get Specified Order Information)
  * [Private Interface - Query History Order] (#Private Interface - Query History Order)
  * [Private Interface - Batch Withdrawal] (#Private Interface - Batch Withdrawal)
